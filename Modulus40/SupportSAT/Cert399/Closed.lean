import Modulus40.SupportSAT.Cert399.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 20304 = false := by
