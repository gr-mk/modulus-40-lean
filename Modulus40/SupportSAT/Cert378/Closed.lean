import Modulus40.SupportSAT.Cert378.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 19387 = false := by
