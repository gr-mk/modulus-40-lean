import Modulus40.SupportSAT.Cert284.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 14080 = false := by
