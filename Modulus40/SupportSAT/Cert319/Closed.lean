import Modulus40.SupportSAT.Cert319.Negative
...
namespace Modulus40.SupportSAT.Cert319
set_option maxRecDepth 100000
set_option maxHeartbeats 0
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 16166 = false := by
  ...
  · exact Modulus40.SupportSAT.Cert313.negative a h
  · exact Modulus40.SupportSAT.Cert314.negative a h
  · exact Modulus40.SupportSAT.Cert315.negative a h
  · exact Modulus40.SupportSAT.Cert316.negative a h
  · exact Modulus40.SupportSAT.Cert317.negative a h
  · exact Modulus40.SupportSAT.Cert318.negative a h
end Modulus40.SupportSAT.Cert319
