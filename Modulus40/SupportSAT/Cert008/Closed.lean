import Modulus40.SupportSAT.Cert008.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 461 = false := by
