import Modulus40.SupportSAT.Cert466.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 26799 = false := by
