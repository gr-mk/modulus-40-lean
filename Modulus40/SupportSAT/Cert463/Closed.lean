import Modulus40.SupportSAT.Cert463.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 26124 = false := by
