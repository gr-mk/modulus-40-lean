import Modulus40.SupportSAT.Cert023.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 592 = false := by
  ...
  · exact Modulus40.SupportSAT.Cert020.negative a h
  · exact Modulus40.SupportSAT.Cert022.negative a h
