import Modulus40.SupportSAT.Cert454.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 24838 = false := by
