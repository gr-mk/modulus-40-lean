import Modulus40.SupportSAT.Cert037.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 966 = false := by
  ...
  · exact Modulus40.SupportSAT.Cert030.negative a h
  · exact Modulus40.SupportSAT.Cert036.negative a h
