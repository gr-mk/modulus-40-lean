import Modulus40.SupportSAT.Cert504.Negative
...
theorem negative (a : Nat → Bool) (h : ExponentAssignmentValid supportNodeCount supportDomainAt supportGateAt a) : a 29673 = false := by
